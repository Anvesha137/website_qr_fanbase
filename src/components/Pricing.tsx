...
export default function Pricing() {
  ...
  const plans: Plan[] = [
    ...
    {
      name: 'Try Me Out',
      description: 'Everything in our Professional plan for 30 days.',
      btn: 'Try Now',
      badge: 'first month only',
      oneTimePrice: 249,
      features: [
        { text: '10 Automations', included: true },
        { text: '10,000 DM’s', included: true },
        { text: 'Story Replies', included: true },
        { text: 'Ask to Follow', included: true },
        { text: 'Carousel DM’s', included: true },
        { text: 'Conversational Flow', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Unlimited DM’s', included: true },
        { text: 'Story Replies', included: true },
        { text: 'Ask to Follow', included: true },
        { text: 'Carousel DM’s', included: true },
        { text: 'Conversational Flow', included: true },
    ...
    },
    {
      ...
      features: [
        ...
        { text: 'Conversational Flow', included: true },
        { text: 'Lead Manager', included: true },
        { text: 'Followup Messages', included: true },
        { text: 'My Store', included: true },
        { text: '1:1 Appointments', included: true },
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4 items-start">
            {[
              ...
              },
              {
                ...
                a: "It's a one-time trial that unlocks everything in our Professional plan — 10 automations, 10,000 DMs, Ask to Follow, MyStore, Creator Invoice Generator, Carousel messages, and Lead Manager — for one full month, so you can test all features before committing. It's available once per account."
              },
              {
                q: 'What happens after my "Try Me Out" ends?',
