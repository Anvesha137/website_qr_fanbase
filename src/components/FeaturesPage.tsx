              ...
              return (
                ...
                >
                  ...
                  <div className="relative z-10 pt-4 border-t border-slate-100 flex items-center justify-between">
                    <span className="text-[10px] font-mono font-bold text-[#695dd4] bg-indigo-50 border border-indigo-100 px-2.5 py-1 rounded">
                      {feat.badge}
                    </span>
                    <span className="text-[10px] font-mono font-bold text-slate-600 bg-slate-100 border border-slate-200/80 px-2.5 py-1 rounded">
                      {feat.stat}
                    </span>
                  </div>
                </motion.div>
