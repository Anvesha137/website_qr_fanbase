...
export default function StayForRest() {
  return (
    <section className="py-24 bg-white" id="stay-for-rest">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-[#f2f2f4] rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative min-h-[440px] shadow-sm hover:shadow-md transition-all duration-300 md:col-span-2 lg:col-span-2">
            <div className="relative w-full h-48 rounded-2xl bg-gradient-to-br from-indigo-900/10 via-purple-600/5 to-slate-200 overflow-hidden flex items-center justify-center">
              <div className="bg-white/80 backdrop-blur-md rounded-full px-6 py-3.5 shadow-2xl flex items-center space-x-4">
          ...
          <div className="bg-[#f2f2f4] rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative min-h-[440px] shadow-sm hover:shadow-md transition-all duration-300 md:col-span-1 lg:col-span-1">
          ...
          <div className="bg-[#f2f2f4] rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative min-h-[440px] shadow-sm hover:shadow-md transition-all duration-300 md:col-span-1 lg:col-span-1">
            <div className="relative w-full h-48 bg-slate-900 rounded-2xl overflow-hidden flex items-center justify-center p-6">
              <div className="bg-white rounded-xl p-3 shadow-2xl border border-slate-100 flex items-center space-x-3 w-full">
          ...
          <div className="bg-[#f2f2f4] rounded-3xl p-8 flex flex-col justify-between overflow-hidden relative min-h-[440px] shadow-sm hover:shadow-md transition-all duration-300 md:col-span-1 lg:col-span-1">
            <div className="relative w-full h-48 bg-slate-950 rounded-2xl flex flex-col items-center justify-center p-6 text-center text-white">
              <div className="h-16 w-32 border-t-[8px] border-x-[8px] border-[#695dd4] rounded-t-full flex flex-col items-center justify-end pb-1.5">
